        ...
        return (
            <div>
                <div className="table-com">
                    <div className="zhu-ti-title">成绩对比图</div>
                    <div className="kemu-list">
                        <ul style={{width:100*this.props.cFen.length+"px"}}>
                            {/* 循环所有的科目 */
                            }
                            {this.props.cFen.map((obj, aa) => {
                                return (
                                    <li
                                        key={aa}
                    ...
                    <ReactHighcharts config={this.props.zhuData || {}} />
                </div>
                <div className="table-com table-zhuz">
                    <div className="zhu-ti-title">偏科对比图</div>
